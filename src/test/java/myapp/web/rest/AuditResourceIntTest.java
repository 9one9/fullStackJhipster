...
import myapp.XSqlJhipsterApp;
import myapp.config.audit.AuditEventConverter;
import myapp.domain.PersistentAuditEvent;
import myapp.repository.PersistenceAuditEventRepository;
import myapp.service.AuditEventService;
...
@SpringBootTest(classes = XSqlJhipsterApp.class)
@Transactional
